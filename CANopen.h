...
#include <stdint.h>
    ...
    #include "sources/CO_OD.h"
    #include "stack/CO_SDO.h"
    #include "stack/CO_Emergency.h"
    #include "stack/CO_NMT_Heartbeat.h"
    #include "stack/CO_SYNC.h"
    #include "stack/CO_PDO.h"
    #include "stack/CO_HBconsumer.h"
#if CO_NO_SDO_CLIENT == 1
    #include "stack/CO_SDOmaster.h"
#endif
#if CO_NO_TRACE > 0
    #include "stack/CO_trace.h"
#endif
